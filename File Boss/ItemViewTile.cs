...
namespace File_Boss
{
    public partial class ItemViewTile : ItemView
    {
        public ItemViewTile()
        {
            InitializeComponent();
        ...
        public override void LoadFile(string File, Icon icon, BackFunctions functionHandler, TabUI t)
		{
            ...
            foreach (var program in functionHandler.ProgramMap.Values)
			{
				...
				programItem.BackColor = copyFileToolStripMenuItem.BackColor;
				programItem.ForeColor = copyFileToolStripMenuItem.ForeColor;
